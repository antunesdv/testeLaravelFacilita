                                ...
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center justify-content-center mb-0 text-center">
                                        ...
                                        @foreach($results as $result)                                                                                
                                            <tr>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0">{{$result->nome}}</p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0">{{$result->autor}}</p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0">{{$result->registro}}</p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0">{{$result->genero}}</p>
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/livros/{{$result->id}}" class="btn btn-sm btn-outline-primary">Ver mais</a>                                                    
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
