                                    ...
                                    <table class="table align-items-center justify-content-center mb-0 text-center">
                                        ...
                                        @foreach($results as $result)                                                                                
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0">{{$result->email}}</p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0">{{$result->statusAlocao}}</p>
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/users/{{$result->id}}" class="btn btn-sm btn-outline-primary">Ver mais</a>                                                    
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/alocarLivro/{{$result->id}}" class="btn btn-sm btn-outline-primary">Alocar Novo Livro</a>                                                    
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
