...
<?php endif; ?>
  ...
  <div class="min-height-300 bg-primary position-absolute w-100"></div>
        ...
        <div class="card-body p-3">
          <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
              <div class="h-100">
              <h5 class="mb-1"> Consulta de Usuários </h5>
              <p class="mb-0 font-weight-bold text-sm"> Usuário </p>
            </div>
          </div>
    ...
    <form action="/atualizarUsers/<?php echo e($results[0]->id); ?>" method="post" >
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nome" value="<?php echo e($results[0]->name); ?>" required>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-text-input" class="form-control-label">Email</label>
                  <input class="form-control" type="email" name="email" value="<?php echo e($results[0]->email); ?>" required>
                </div>
              </div>              
              <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />                        
          </div>        
          <button type="submit" class="btn btn-primary btn-sm ms-auto">Atualizar Usuário</button>
          <a href="/deletarUsers/<?php echo e($results[0]->id); ?>" type="submit" class="btn btn-danger btn-sm ms-auto">Deletar Usuário</a>
        </div>
      </div>            
    </form>
  </div>
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0 text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nº Registro</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Gênero</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Data devolução</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Devolver Livro</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php $__currentLoopData = $rs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                                                
                                            <tr>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($r->nome); ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($r->autor); ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($r->registro); ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($r->genero); ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($r->dataDevolucao); ?></p>
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/livrosDevolucao/<?php echo e($results[0]->id); ?>/<?php echo e($r->id); ?>" class="btn btn-sm btn-outline-primary">Devolver Livro</a>                                                    
                                                </td>
                                            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\testeAppFacilita\resources\views/consultaUsersAll.blade.php ENDPATH**/ ?>