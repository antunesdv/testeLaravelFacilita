  ...
  <style>
    ...
    <main class="main-content position-relative border-radius-lg ps">
        ...
        <div class="container-fluid py-1 px-3">
            ...
            <h6 class="font-weight-bolder text-white mb-0">Consulta de Usuários</h6>
            </nav>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">            
                                    <div class="card-body">            
                                        <form action="filtrarUsers" method="post">
                                            <div class="row">                                            
                                                <div class="col-md-6">                                                                                                    
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0 text-center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Status Alocação</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Mais informações</th>
                                        ...
                                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                                                
                                            <tr>
                                                <td>
                                                    <div class="my-auto">
                                                        <!-- DIV Abaixo mostra o icon do cliente cadastrado
                                                         <div>
                                                            <img src="../assets/img/small-logos/logo-spotify.svg" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                                                        </div> -->
                                                        <div class="my-auto">
                                                            <h6 class="mb-0 text-sm"><?php echo e($result->name); ?></h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($result->email); ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($result->statusAlocao); ?></p>
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/users/<?php echo e($result->id); ?>" class="btn btn-sm btn-outline-primary">Ver mais</a>                                                    
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/alocarLivro/<?php echo e($result->id); ?>" class="btn btn-sm btn-outline-primary">Alocar Novo Livro</a>                                                    
                                                </td>
                                            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\testeAppFacilita\resources\views/consultaUsers.blade.php ENDPATH**/ ?>