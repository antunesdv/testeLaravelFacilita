                                    ...
                                    <table class="table align-items-center justify-content-center mb-0 text-center">
                                        ...
                                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                                                                
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($result->registro); ?></p>
                                                </td>
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><?php echo e($result->genero); ?></p>
                                                </td>
                                                <td style="padding-top:25px !important">
                                                    <a  href="/livros/<?php echo e($result->id); ?>" class="btn btn-sm btn-outline-primary">Ver mais</a>                                                    
                                                </td>
                                            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\testeAppFacilita\resources\views/consultaLivros.blade.php ENDPATH**/ ?>