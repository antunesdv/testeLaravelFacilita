...
<?php endif; ?>
  ...
  <div class="min-height-300 bg-primary position-absolute w-100"></div>
    ...
    <form action="/UsersCadastro" method="post" >
      <div class="container-fluid py-4">
        <div class="row">
          ...
          <button type="submit" class="btn btn-primary btn-sm ms-auto">Cadastrar Usuário</button>
        </div>
      </div>            
    </form>
  </div>
  ...
  const $input2 = document.querySelector('[data-js="input2"]')
  $input2.addEventListener('input', handleInput2, false)
...
</html><?php /**PATH C:\xampp\htdocs\testeAppFacilita\resources\views/cadastroUsers.blade.php ENDPATH**/ ?>